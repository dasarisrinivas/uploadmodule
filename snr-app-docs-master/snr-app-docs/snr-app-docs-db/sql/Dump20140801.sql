...
INSERT INTO `order_item_group_shipping_details` VALUES ('1','1','1','2009-05-18 00:00:00','2009-05-18 00:00:00','1','ww','1',1,NULL,NULL),('2','1','1','2009-05-18 00:00:00','2009-05-18 00:00:00','2','qw','2',NULL,NULL,NULL);
...
INSERT INTO `order_items` VALUES ('1','1','1',11,1,'1',NULL,'1'),('2','1','2',111,2,'1',NULL,'1');
...
CREATE TABLE `orders` (
  ...
  `CUSTOMER_SHIPPING_ADDRESS_ID` varchar(16) DEFAULT NULL,
  `ORDER_VALUE_BEFORE_TAX` float DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
INSERT INTO `orders` VALUES ('1','1','2009-05-18 00:00:00',1,1,1,'1',1,'1',NULL),('2','2','2014-05-18 00:00:00',1,2,1,'1',1,'1',NULL);
...
-- Dump completed on 2014-08-01  9:30:10
